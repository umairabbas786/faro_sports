                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xl-3 pe-xl-5 pt-9 pt-lg-0 shop-mob-toggle collapse d-lg-block"
                            id="shop_filter">
                            <!-- Mobile Toggle --> <button class="shop-sidebar-toggle-btn btn-close d-lg-none"
                                type="button" data-bs-toggle="collapse" data-bs-target="#shop_filter"
                                aria-controls="shop_filter" aria-expanded="false"
                                aria-label="Toggle navigation"></button><!-- End Mobile Toggle -->
                            <!-- Categories -->
                            <div class="shop-sidebar-block">
                                ...
                                <div class="shop-category-list collapse show" id="shop_categories">
                                    <ul class="nav flex-column">
                                        <li class="nav-item"><a style="color: #CC0000;" href="#" class="nav-link active">All Products</a></li>
                                        <li class="nav-item"><a style="color: white;" href="#" class="nav-link">Sports Wear</a> <a
                                                data-bs-toggle="collapse" href="#shop_cat_1" role="button"
                                                aria-expanded="false" aria-controls="shop_cat_1" class="s-icon" style="color: white;">+</a>
                                        ...
                                        <li class="nav-item"><a style="color: white;" href="#" class="nav-link">Sports Gear</a> <a
                                                data-bs-toggle="collapse" href="#shop_cat_2" role="button"
                                                aria-expanded="false" aria-controls="shop_cat_2" class="s-icon" style="color: white;">+</a>
                                        ...
                                        <li class="nav-item"><a style="color: white;" href="#" class="nav-link">Accessories</a> <a
                                                data-bs-toggle="collapse" href="#shop_cat_3" role="button"
                                                aria-expanded="false" aria-controls="shop_cat_3" class="s-icon" style="color: white;">+</a>
                        ...
                        <div class="col-lg-8 col-xl-9">
                            <div class="shop-top-bar d-flex pb-3">
                                <div class="layout-change">
                                    <!-- Mobile Toggle --> <button class="btn btn-sm d-lg-none" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#shop_filter"
                                        aria-controls="shop_filter" aria-expanded="false"
                                        aria-label="Toggle navigation"><i
                                            class="fs-4 lh-1 bi bi-justify-left"></i></button><!-- End Mobile Toggle -->
                                    <a class="btn btn-sm active" href="#"><i class="bi bi-grid"></i></a> <a
                                        class="btn btn-sm" href="shop-list.html"><i class="bi bi-view-stacked"></i></a>
                                </div>
                ...
                <div class="product-card-info">
                  ...
                  <div class="product-price"><span class="text-primary">$28.<small>50</small></span> <del
                      class="fs-sm text-muted">$38.<small>50</small></del></div>
                                ...
                                <h3 style="color: #CC0000;">Sports Gear</h3>
                                <div class="col-sm-6 col-lg-4">
                                <div class="product-card-1">
                <div class="product-card-image">
                ...
                <div class="product-card-info">
                  ...
                  <div class="product-price"><span class="text-primary">$28.<small>50</small></span> <del
                      class="fs-sm text-muted">$38.<small>50</small></del></div>
                                ...
                                <h3 style="color: #CC0000;">Accessories</h3>
                                <div class="col-sm-6 col-lg-4">
                                <div class="product-card-1">
                <div class="product-card-image">
